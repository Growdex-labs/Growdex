...
import OnBoardingSteps from "./pages/Onboarding/Onboarding.jsx"
...
function Router() {
  ...
  path="/verify-email"
  element={
    <RedirectFlowGuard type="verify-email">
...
/>
  ...
  element={
    <RedirectFlowGuard type="reset-password">
      <ResetPasswordPage />
    </RedirectFlowGuard>
  }
/>
...
<Route
  ...
  element={
   <FlowProtectedRoute requireOnboarding={true}>
      <OnBoardingSteps />
    </FlowProtectedRoute>
  }
/>
