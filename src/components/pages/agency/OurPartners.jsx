        ...
        <div className="relative mx-auto w-full md:w-screen max-w-7xl px-4 bg-[#333333] text-white
            ...
            <div className="w-full flex flex-col md:flex-row gap-3 md:gap-0
                ...
                <div className="flex flex-col gap-2 justify-center">
                    ...
                    <br />
                    <p>We don't just run ads.</p>
                    <p className="max-w-md max-sm:text-xs">We build and manage marketing systems that perform-so your brand
                        can scale faster with less guesswork.
                    </p>
                </div>
                {/* logos */}
